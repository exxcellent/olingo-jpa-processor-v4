...
public final class JPAEdmNameBuilder {
  ...
  /**
   * Same as {@link #JPAEdmNameBuilder(String, NamingStrategy) JPAEdmNameBuilder(namespace,
   * NamingStrategy.UpperCamelCase)}
   */
  public JPAEdmNameBuilder(final String namespace) {
    this(namespace, NamingStrategy.UpperCamelCase);
  }

  public JPAEdmNameBuilder(final String namespace, final NamingStrategy attributeNamingStrategy) {
    super();
  ...
  final public String buildPropertyName(final String jpaAttributeName) {
    switch (attributeNamingStrategy) {
    case AsIs:
      return jpaAttributeName;
    case UpperCamelCase:
      return firstToUpper(jpaAttributeName);
    default:
      throw new UnsupportedOperationException(attributeNamingStrategy + " is not supported");
    }
  }
