...
public class JPAMemberOperator implements JPAOperator {
  ...
  public Path<?> get() throws ODataApplicationException {
    final JPAAttributePath selectItemPath = determineAttributePath();
  ...
  private JPAAttributePath determineAttributePath() throws ODataApplicationException {
  ...
  private Path<?> determineCriteriaPath(final JPAAttributePath selectItemPath) {
    Path<?> p = root;
