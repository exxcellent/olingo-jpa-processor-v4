...
public abstract class AbstractCriteriaQueryBuilder<QT extends CriteriaQuery<DT>, DT> extends AbstractQueryBuilder {
  ...
  private javax.persistence.criteria.Expression<Boolean> createWhereFromCustomizer()
      throws ODataApplicationException {
  ...
  ODataJPAModelException {
    ...
    final javax.persistence.criteria.Expression<Boolean> customizerClause = createWhereFromCustomizer();
