...
Annotation | Usage
---------- | --------------------
org.apache.olingo.jpa.cdi.Inject, jakarta.inject.Inject | Mark an field or action parameter as injected by OData-JPA-Adapter runtime (see [Dependency Injection](DependencyInjection.md))
