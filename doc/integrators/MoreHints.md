...
* *@jakarta.validation.constraints.NotNull*: Mark an attribute or operation parameter as not *nullable*
* *@jakarta.validation.constraints.Size*: Can be used to override the *length* attribute of the *@jakarta.persistence.Column* annotation
