...
public class CallOperationsIT {
  ...
  @Ignore
  @Test
  public void testDataConversionActionUnbound() throws Exception {
    ...
    final ClientComplexValue modifiedObject = new ClientComplexValueImpl(Constant.PUNIT_NAME
        + ".DatatypeConversionEntity");
    actionParameters.put("jpaEnity", modifiedObject);

    modifiedObject.add(new ClientPropertyImpl("ID", new ClientPrimitiveValueImpl.BuilderImpl().buildInt32(Integer
        .valueOf(123))));

    String dateString = Integer.toString(LocalDate.now().getYear() - 1) + "-01-01";
    modifiedObject.add(new ClientPropertyImpl("ADate1", new ClientPrimitiveValueImpl.BuilderImpl().buildString(
        dateString)));
    dateString = Integer.toString(LocalDate.now().getYear() + 1) + "-01-01";
    modifiedObject.add(new ClientPropertyImpl("ADate2", new ClientPrimitiveValueImpl.BuilderImpl().buildString(
        dateString)));
    dateString = Integer.toString(LocalDate.now().getYear()) + "-01-31";
    modifiedObject.add(new ClientPropertyImpl("ADate3", new ClientPrimitiveValueImpl.BuilderImpl().buildString(
        dateString)));
    modifiedObject
    ...
    modifiedObject.add(new ClientPropertyImpl("AOrdinalMappedEnum",
        new ClientPrimitiveValueImpl.BuilderImpl().buildString(ChronoUnit.HOURS.name())));
    modifiedObject.add(new ClientPropertyImpl("AEnumFromOtherPackage",
        new ClientPrimitiveValueImpl.BuilderImpl().buildString(TestEnum.Two.name())));
    modifiedObject.add(new ClientPropertyImpl("Uuid", new ClientPrimitiveValueImpl.BuilderImpl().buildGuid(UUID
        .randomUUID())));
    modifiedObject.add(new ClientPropertyImpl("ABoolean", new ClientPrimitiveValueImpl.BuilderImpl().buildBoolean(
        Boolean.TRUE)));
    modifiedObject
